 ...
 *       Filename:  parser.h
 *
 *    Description:  parser的头文件
 *
 *        Version:  1.0
 *        Created:  2013年04月10日 10时42分04秒
 *       Revision:  none
 *       Compiler:  gcc
 *
...
// 最多能接收10000个字符的串
int w[10000];
                          // 构建一个整型数组来存储输入串,将每个符号都转换为相应的ascii值存储
...
void init_Pro(Pro* produce)
{
    ...
    strcpy(produce[1].Str, "program => prog id semi declarations begin procedure statement_lis  procedure end");
    produce[1].Length = 9;
...
void init_w(int* w)
{
	...
	w[3] = 4;
	//id , id : integer semi
	w[4] = 1; w[5] = 3; w[6] = 1; w[7] = 5; w[8] = 6; w[9] = 2;
	//begin
	w[10] = 18;
	//readln (id) semi
	w[11] = 20; w[12] = 22; w[13] = 1; w[14] = 23; w[15] = 2;

	//id assignop num semi
 	w[16] = 1;  w[17] = 10; w[18] = 17; w[19] = 2;
    //if id gtop num then id assignop id subop id semi 
	w[20] = 7; w[21] = 1; w[22] = 15; w[23] = 17; w[24] = 8; 
	w[25] = 1; w[26] = 10; w[27] = 1; w[28] = 12; w[29] = 1; w[30] =2;
	
	//else id assignop id addop id semi 
	w[31] = 9; w[32] = 1; w[33] = 10; w[34] = 1; w[35] = 11; w[36] = 1; w[37] = 2;
    
	//while id lsop num 
   	w[38] = 25; w[39] = 1; w[40] = 16; w[41] = 17;
	//do id assignop num semi 
	w[42] = 26; w[43] = 1; w[44] = 10; w[45] = 17; w[46] = 2;

	//writeln (id) semi 
	w[47] = 21; w[48] = 22; w[49] = 1;  w[50] = 23; w[51] = 2;
